...
import heroImage from '../assets/images/photos/escaliers2-outfit.webp';
import exempleOutfit from '../assets/images/photos/exemple-outfit.webp';
import pullBleu from '../assets/images/photos/Pull-bleu.webp';
import BulleTexte from '../assets/images/illustrations/Bulle-texte.svg';
import abeilleEtape2 from '../assets/images/illustrations/abeille-etape2.webp';
      ...
      <main className="bg-hive-pale overflow-x-hidden flex flex-col space-y-32 md:space-y-48" role="main">
        ...
        <section className="min-h-screen flex items-center justify-center container mx-auto" aria-label="Section d'explication">
          <h2 className="font-piepie text-center tracking-wider flex flex-col items-center space-y-8 md:space-y-12 lg:space-y-16 w-full overflow-hidden px-4 sm:px-8 lg:px-12 max-w-[1600px] mx-auto">
            <span className="text-3xl sm:text-4xl lg:text-6xl xl:text-7xl text-hive-black relative z-10 text-center slide-up whitespace-nowrap inline-block w-full max-w-full overflow-hidden leading-tight">ON VOUS EXPLIQUE</span>
            <span className="text-4xl sm:text-5xl lg:text-8xl xl:text-9xl text-hive-black relative z-10 text-center slide-up whitespace-nowrap inline-block w-full max-w-full overflow-hidden leading-none">COMMENT</span>
            <span className="text-3xl sm:text-4xl lg:text-6xl xl:text-7xl text-hive-black relative z-10 text-center slide-up whitespace-nowrap inline-block w-full max-w-full overflow-hidden leading-tight">ÇA FONCTIONNE EN</span>
            <span className="relative inline-block slide-up w-full max-w-full overflow-hidden">
              <span className="text-4xl sm:text-5xl lg:text-7xl xl:text-8xl text-hive-black [text-shadow:_-2px_-2px_0_#111111,_2px_-2px_0_#111111,_-2px_2px_0_#111111,_2px_2px_0_#111111] absolute top-1 z-0 left-0 right-0 whitespace-nowrap text-center leading-none">TROIS ÉTAPES</span>
              <span className="text-4xl sm:text-5xl lg:text-7xl xl:text-8xl text-hive-pale [text-shadow:_-2px_-2px_0_#111111,_2px_-2px_0_#111111,_-2px_2px_0_#111111,_2px_2px_0_#111111] relative z-10 whitespace-nowrap text-center leading-none">TROIS ÉTAPES</span>
            </span>
            <span className="text-3xl sm:text-4xl lg:text-7xl xl:text-8xl text-hive-black relative z-10 text-center slide-up whitespace-nowrap inline-block w-full max-w-full overflow-hidden leading-none">SUPER SIMPLES !</span>
          </h2>
        </section>
        ...
        <section className="min-h-screen container mx-auto flex flex-col items-center py-16 md:py-24">
          ...
          <div className="w-full max-w-[970px] mx-auto bg-white rounded-3xl border-2 border-hive-black p-4 sm:p-6 md:p-8 lg:p-10 shadow-[8px_8px_0_0_#FFAF02,_8px_8px_0_2px_#111111] h-[600px] sm:h-[700px] overflow-hidden">
            <div className="flex flex-col lg:flex-row w-full gap-4 sm:gap-6 lg:gap-12 h-full overflow-hidden">
              ...
              <div className="w-full lg:w-1/2 overflow-y-auto scrollbar-thin scrollbar-track-transparent">
                <div className="flex items-center justify-between mb-4 sm:mb-6">
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="aspect-square w-8 sm:w-10 lg:w-12 rounded-full bg-hive-orange border-2 border-hive-black"></div>
                    <span className="font-piepie text-sm sm:text-base">@marie_fashion</span>
                  </div>
                </div>

                <div className="mb-4 sm:mb-6">
                  <div className="flex items-center gap-2 text-hive-black/60 cursor-pointer">
                    <span className="text-sm sm:text-base">Afficher moins</span>
                    <svg
                  ...
                  <div className="mt-3 sm:mt-4">
                    <p className="text-hive-black/80 text-sm sm:text-base">Help ! J'ai ce super blazer orange mais je ne sais pas comment le porter pour une soirée décontractée 🧡 Des idées ?</p>
                    <span className="inline-block mt-2 text-xs sm:text-sm text-hive-black/60 font-satoshi">#vintage</span>
                  </div>
                </div>

                <div className="relative aspect-square w-full max-w-[500px] mx-auto mb-4 sm:mb-6">
                  <img
                    src={exempleOutfit}
                    alt="Exemple de tenue"
                    className="w-full h-full object-cover rounded-xl border-2 border-hive-black cursor-pointer hover:opacity-90 transition-opacity"
              ...
              <div className="w-full lg:w-1/2 flex flex-col h-full overflow-hidden">
                <div className="flex-grow overflow-y-auto scrollbar-thin scrollbar-track-transparent pr-2">
                  {/* Commentaire 1 */}
                  <div className="mb-4 sm:mb-6">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2 sm:gap-4">
                        <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-hive-pink border-2 border-hive-black"></div>
                        <span className="font-piepie text-sm sm:text-base">@style_guru</span>
                      </div>
                      <button className="flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-5 sm:h-5 text-hive-black/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                        </svg>
                        <span className="text-sm sm:text-base text-hive-black/50">12</span>
                      </button>
                    </div>
                    <p className="text-sm sm:text-base text-hive-black/80 ml-8 sm:ml-12">Je te conseille de le porter avec un jean droit et un t-shirt blanc basique. Ajoute des baskets blanches pour un look casual chic ! 👌</p>
                  </div>
                  ...
                  <div className="mb-4 sm:mb-6">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2 sm:gap-4">
                        <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-hive-purple border-2 border-hive-black"></div>
                        <span className="font-piepie text-sm sm:text-base">@fashionista</span>
                      </div>
                      <button className="flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-5 sm:h-5 text-hive-black/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                        </svg>
                        <span className="text-sm sm:text-base text-hive-black/50">8</span>
                      </button>
                    </div>
                    <p className="text-sm sm:text-base text-hive-black/80 ml-8 sm:ml-12">Essaie avec une robe noire courte et des bottines ! Le contraste sera super stylé 👌</p>
                  </div>
                  ...
                  <div className="mb-4 sm:mb-6">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2 sm:gap-4">
                        <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-hive-yellow border-2 border-hive-black"></div>
                        <span className="font-piepie text-sm sm:text-base">@trendy_bee</span>
                      </div>
                      <button className="flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-5 sm:h-5 text-hive-black/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                        </svg>
                        <span className="text-sm sm:text-base text-hive-black/50">5</span>
                      </button>
                    </div>
                    <p className="text-sm sm:text-base text-hive-black/80 ml-8 sm:ml-12">Pour une touche plus casual, associe-le avec un jean déchiré et un crop top noir. Ajoute des bijoux dorés pour upgrader la tenue ! ✨</p>
                  </div>
                </div>
                ...
                <form className="mt-auto relative">
                  <textarea
                    ...
                    className="w-full p-2 sm:p-3 border-2 border-hive-black rounded-xl resize-none shadow-[0_3px_0_0_#111111] focus:outline-none focus:border-hive-black focus:bg-hive-yellow text-sm sm:text-base"
                    rows={2}
                  />
                  <button
                    type="submit"
                    className="absolute bottom-2 sm:bottom-3 right-2 sm:right-3 p-1 sm:p-2 text-hive-black disabled:opacity-50 disabled:cursor-not-allowed"
                  >
